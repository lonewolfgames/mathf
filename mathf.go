...
func DirectionRads( a float32 ) string{
	...
	if a > Pi_15_16 && a < Pi_1_16 { return RIGHT }
	if a > Pi_1_16 && a < Pi_3_16 { return UP_RIGHT }
	if a > Pi_3_16 && a < Pi_5_16 { return UP }
	if a > Pi_5_16 && a < Pi_7_16 { return UP_LEFT }
	if a > Pi_7_16 && a < Pi_9_16 { return LEFT }
	if a > Pi_9_16 && a < Pi_11_16 { return DOWN_LEFT }
	if a > Pi_11_16 && a < Pi_13_16 { return DOWN }
	if a > Pi_13_16 && a < Pi_15_16 { return DOWN_RIGHT }
...
func Min( nums...float32 ) float32{
	...
	for i := 1; i < len; i++ {
		...
		if i+1 > len - 1 { b = nums[0] }else{ b = nums[ i+1 ] }
		if a < b { min = a }
	}
