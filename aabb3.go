...
func ( this *AABB3 ) Empty() *AABB3{
	...
	this.Min.Set( math.MaxFloat32, math.MaxFloat32, math.MaxFloat32 )
	this.Max.Set( -math.MaxFloat32, -math.MaxFloat32, -math.MaxFloat32 )
...
func ( this *AABB3 ) Contains( v *Vec3 ) bool{
	...
	if v[0] < this.Min[0] { return false }
	if v[1] < this.Min[1] { return false }
	if v[2] < this.Min[2] { return false }
	
	if v[0] > this.Max[0] { return false }
	if v[1] > this.Max[1] { return false }
	if v[2] > this.Max[2] { return false }
...
func ( this *AABB3 ) Intersects( other *AABB3 ) bool{
	...
	if other.Max[0] < this.Min[0] { return false }
	if other.Max[1] < this.Min[1] { return false }
	if other.Max[2] < this.Min[2] { return false }
	
	if other.Min[0] > this.Max[0] { return false }
	if other.Min[1] > this.Max[1] { return false }
	if other.Min[2] > this.Max[2] { return false }
